...
public class Console implements IView{
    ...
    public int presentMainMenu() {
        ...
        if (isInteger(menuAlternative, 10)){
            return input;
        }else {
    ...
    public String presentLogin() {
        System.out.println("Enter your username (leave empty to continue without logging in):");
        return in.nextLine();
    }
    ...
    @Override
    public String presentSearchBy() {
        System.out.println("1. Name");
        System.out.println("2. Under Age");
        System.out.println("3. Over Age");
        String menuAlternative = in.nextLine();
    ...
    public String presentAndOr() {
        ...
        String menuAlternative = in.nextLine();
        if (isInteger(menuAlternative, 2)){
            if(input==1){
                return "and";
            } else {
                return "or";
    ...
    public boolean presentAddMoreFilters() {
        System.out.println("Add another filter?");
